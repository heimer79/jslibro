<?php
	...
	// Recuperación del argumento pasado por la application client
	$code = $_POST["codigo"];
	
    // Definición de la consulta SQL que se debe enviar
    // a la Base De Datos MySQL
	$consulta_sql =
	"select codigo_coche, nombre_coche,
	velocidad_maxima_coche
	from coches
	where codigo_coche='$code';";
	...
	else
	{
    	...
    	else
		{
			...
			else
			{
				...
				{
                    // Situar los 3 campos
                    // (codigo_coche, nombre_coche y velocidad_maxima_coche)
                    // del registro actual
